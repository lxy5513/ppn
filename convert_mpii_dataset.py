...
def main():
    ...
    parser.add_argument('matfile', default='/home/xyliu/data/mpii/mpii_human_pose_v1_u12_2/mpii_human_pose_v1_u12_1.mat')
    parser.add_argument('output', default='/home/xyliu/data/mpii/mpii.json')
